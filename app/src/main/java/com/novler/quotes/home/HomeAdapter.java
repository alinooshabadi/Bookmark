...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public HomeAdapter(Context context, List<QuoteListData> data, OnItemClickListener listener) {
        this.data = data;
    ...
    public void onBindViewHolder(HomeAdapter.ViewHolder holder, int position) {
        ...
        String images = data.get(position).getNovelmage();
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void share(final QuoteListData cityListData, final OnItemClickListener listener) {
            shareTelegram.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onClick(cityListData, v);
                }
            });
        }

        void click(final QuoteListData cityListData, final OnItemClickListener listener) {
